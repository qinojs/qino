...
export { fakeMail, messagingChannel as mailMessagingChannel } from "../module/mail/tests/deps.ts";
export { dbSchema as messagingDbSchema } from "../module/messaging/tests/deps.ts";
