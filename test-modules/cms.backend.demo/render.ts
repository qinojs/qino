...
export function render(node: Node): Promise<HtmlString> {
  ...
  return html.async`<div class="u2-card">
    ...
    <div>
      <p>${t`Fills the installation with pages, users, groups, visits and more — enough to see how the backend behaves with real amounts of data. Only what a run created is written; a new run removes the previous data first and leaves everything else untouched.`}
