...
| file                          | served as                     |
|-------------------------------|-------------------------------|
| `qg/cms.cont.html/12.html`    | — (the source, never served)  |
| `qg/cms.cont.html/pub/12.css` | `qg/cms.cont.html/pub/12.css` |
| `qg/cms.cont.html/pub/12.js`  | `qg/cms.cont.html/pub/12.js`  |
...
Paths and creation live in [codeFiles.ts](codeFiles.ts); `qg/<module>/` is what the
app keeps for a module ([Module.appDir](../core/lib/ModuleManager.ts)).
