  ...
  <div class=-standalone>
    <div class=-h1>
      ...
      <div>
        ...
        <form method=post action="${logoutUrl}" style="display:inline"><input type=hidden name=csrfToken value="${hee(ctx.csrfToken)}"><button name=core_logout>${await app.t`log out`}</button></form>
      </div>
    </div>
  </div>
