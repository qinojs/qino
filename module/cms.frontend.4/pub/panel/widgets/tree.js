...
export default async function (widget, { node, dialogs, signal }) {
  ...
  <div class=-standalone>
    ...
    <table class=-padding style="line-height:1">
      ...
      <tr><td style="text-align:center"><span style="font-family:'Material Icons';font-size:1.7em">lock</span><td>${t`The page is not publicly accessible`}
      <tr><td style="text-align:center"><span style="font-family:'Material Icons';font-size:1.7em">schedule</span><td>${t`The page is scheduled and currently not online`}
    </table>
  </div>`;
